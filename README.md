...
Want to help?  [Make a donation](https://aecreations.io/donate.php) or [add a translation](https://crowdin.com/project/readnext).
...
2. Create a new branch originating from the branch for the current major version, `branches/1.6`.  The new branch is where you should commit your code changes.  The branch name should follow the naming convention `branches/your-branch-name`.
